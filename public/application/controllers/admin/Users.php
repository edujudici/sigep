...
class Users extends Admin_Controller {
	...
	public function create()
	{
		...
		else
		{
			...
			$this->data['limit_tags'] = array(
				'name'  => 'limit_tags',
				'id'    => 'limit_tags',
				'type'  => 'number',
                'class' => 'form-control',
				'value' => $this->form_validation->set_value('limit_tags'),
			);
	...
	public function edit($id)
	{
		...
		if (isset($_POST) && ! empty($_POST))
		{
			...
			if ($this->form_validation->run() == TRUE)
			{
				$data = array(
					...
					'company'    => $this->input->post('company'),
					'phone'      => $this->input->post('phone'),
					'limit_tags'      => $this->input->post('limit_tags')					
				);
		...
		$this->data['limit_tags'] = array(
			...
			'type'  => 'number',
            'class' => 'form-control',
			'value' => $this->form_validation->set_value('limit_tags', $user->limit_tags)
		);		
		$this->data['phone'] = array(
			'name'  => 'phone',
			'id'    => 'phone',
	...
	public function profile($id)
	{
        ...
        $this->data['etiqueta'] = $this->db->join('enderecos', 'enderecos.id = remetente')->where('user_id', $id)->get('etiquetas')->result();
